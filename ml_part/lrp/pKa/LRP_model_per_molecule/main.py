...
if __name__ == '__main__':
    ...
    for index_train, row_train in tqdm(df.iterrows()):
        ...
        output_png_path = rf'data\lrp_results\pka\LRP_3_models_2cv_oss\pKa_{SMILES}.png'
        pka_lrp.save_molecule_with_relevances(output_png_path=output_png_path)

        molecules_relevance_fluorine_group[SMILES] = pka_lrp.relevance_fluorine_group
