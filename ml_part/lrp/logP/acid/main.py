...
if __name__ == '__main__':
    ...
    for index, row in df.iterrows():
        ...
        # SMILES = 'O=C(Nc1ccccc1)C1(C(F)(F)F)CCC1'
        ...
        output_svg_path = rf'data\lrp_results\logp\carboxilic_acid\SME_by_groups_nitrogen_with_cooh\logP_{SMILES}.svg'
        output_png_path = rf'data\lrp_results\logp\carboxilic_acid\SME_by_groups_nitrogen_with_cooh\logP_{SMILES}.png'
