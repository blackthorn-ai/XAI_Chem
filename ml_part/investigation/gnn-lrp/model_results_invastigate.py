...
if __name__ == '__main__':
    ...
    smiles, true_pKa = extract_smiles(pKa_amine_data_csv)

    pred = []
    for smile_index in range(len(smiles)):
        pred.append(evaluate(amine_model, smiles[smile_index], true_pKa[smile_index], args, exp_config))
